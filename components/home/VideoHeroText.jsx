...
const VideoHeroText = () => {
  ...
  return (
    <div className="relative z-10 mx-auto max-w-7xl flex min-h-screen flex-col text-center items-center justify-center md:items-start md:text-left px-4 md:px-6 lg:px-8 w-full">
      <p>
        <span className="mb-3 flex text-center items-center justify-center md:justify-start md:items-start md:text-left text-base text-white/80 md:text-lg uppercase tracking-wider">
          Our Websites are <br/>
        </span>
        <span className="text-4xl md:text-6xl lg:text-7xl font-sfHeavy tracking-wide text-white/70 subpixel-antialiased uppercase">
      ...
      <div className="mt-8 flex flex-col items-center gap-4 md:flex-row w-full">
        {phoneLink && (
          <a
            href={phoneLink}
